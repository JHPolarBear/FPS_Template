...
const FName  AFPSAIController_SimplePatrol::HomePosKey(TEXT("HomePos"));
const FName  AFPSAIController_SimplePatrol::NextPosKey(TEXT("NextPos"));
const FName  AFPSAIController_SimplePatrol::FindNextPosKey(TEXT("FindNextPos"));

AFPSAIController_SimplePatrol::AFPSAIController_SimplePatrol()
{
...
void AFPSAIController_SimplePatrol::OnPossess(APawn* InPawn)
{
